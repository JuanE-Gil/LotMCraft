...
public class StructuralCollapseAbility extends Ability {
    ...
    public void onAbilityUse(Level level, LivingEntity entity) {
        ...
        // Damage entities
        AbilityUtil.damageNearbyEntities(serverLevel, entity, 35*(int) Math.max(multiplier(entity)/4,1), DamageLookup.lookupDamage(2, .8) *multiplier(entity), targetLoc, true, true, ModDamageTypes.source(level, ModDamageTypes.DEMONESS_GENERIC, entity));
